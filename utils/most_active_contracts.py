...
def most_active_eq():
       ...
       try:
              ...
              '''columns:
              ['symbol', 'identifier', 'lastPrice', 'pChange', 'quantityTraded',
                     'totalTradedVolume', 'totalTradedValue', 'previousClose', 'exDate',
                     'purpose', 'yearHigh', 'yearLow', 'change', 'open', 'closePrice',
                     'dayHigh', 'dayLow', 'lastUpdateTime']'''
